            ...
            <div class="row gutter-4 justify-content-between">
                ...
                <aside class="col-lg-3">
                    <div class="nav nav-pills flex-column lavalamp" id="sidebar-1" role="tablist">
                        ...
                        <a class="nav-link" data-toggle="tab" href="#sidebar-1-2" role="tab" aria-controls="sidebar-1-2" aria-selected="false">Orders</a>
                        <a class="nav-link" data-toggle="tab" href="#sidebar-1-3" role="tab" aria-controls="sidebar-1-3" aria-selected="false">Addresses</a>
                        <a class="nav-link" data-toggle="tab" href="#sidebar-1-4" role="tab" aria-controls="sidebar-1-4" aria-selected="false">Payments</a>
                        <a class="nav-link" data-toggle="tab" href="#sidebar-1-5" role="tab" aria-controls="sidebar-1-5" aria-selected="false">Wishlist</a>
                    </div>
                </aside>
                <!-- / sidebar -->
                                    ...
                                    <div class="row gutter-2">
                                        <div class="col-12">
                                            <div class="order">
                                                <div class="row align-items-center">
                                                    <div class="col-lg-4">
                                                        <h3 class="order-number">Order 451534</h3>
                                                        <a href="#!" class="action eyebrow underline">View Order</a>
                                                    </div>
                                                    <div class="col-lg-4">
                                                        <span class="order-status sent">Shipped on 15 Apr, 2019</span>
                                                    </div>
                                                    <div class="col-lg-4">
                                        ...
                                        <div class="col-12">
                                            <div class="order">
                                                <div class="row align-items-center">
                                                    <div class="col-lg-4">
                                                        <h3 class="order-number">Order 165342</h3>
                                                        <a href="#!" class="action eyebrow underline">View Order</a>
                                                    </div>
                                                    <div class="col-lg-4">
                                        ...
                                        <div class="col-12">
                                            <div class="order">
                                                <div class="row align-items-center">
                                                    <div class="col-lg-4">
                                                        <h3 class="order-number">Order 524312</h3>
                                                        <a href="#!" class="action eyebrow underline">View Order</a>
                                                    </div>
                                                    <div class="col-lg-4">
                                                        <span class="order-status">In Progress</span>
                                                    </div>
                                                    <div class="col-lg-4">
                                                        <ul class="order-preview justify-content-end">
